			...
			<view class="table_wrap">
				<uni-table border stripe emptyText="暂无更多数据">
					<uni-tr style="background: #f6f6f6;">
						...
						<uni-th align="center" style="font-size: 14px;font-weight: 600;color:#333;">奖励编号</uni-th>
...
<script>
	...
	export default {
		...
		methods: {
			...
			getList() {
				let url = "/admin/pay-reward?page=" + this.currentPage +
					"&invitee=" + this.searEmployee + "&inviter=" + this.searUser + "&page_size=" + this.currentCount +
					"&start_time=" + this
					.searStart + "&end_time=" + this.searEnd
